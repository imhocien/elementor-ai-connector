...
class EMCP_Tools_Bootstrap {
	...
	private static function load_classes(): void {
		...
		// Responsive settings MCP tool (breakpoint-aware element settings).
		require_once EMCP_TOOLS_DIR . 'includes/abilities/class-responsive-abilities.php';
		// Motion effects, positioning, background overlays — convenience tools for
		// Elementor's Advanced-tab settings that would otherwise require raw keys.
		require_once EMCP_TOOLS_DIR . 'includes/abilities/class-motion-abilities.php';
		require_once EMCP_TOOLS_DIR . 'includes/abilities/class-position-abilities.php';
		require_once EMCP_TOOLS_DIR . 'includes/abilities/class-overlay-abilities.php';
		// Loop Grid builder — composite tool: creates loop item template + adds
		// configured loop-grid widget in one call. Requires Elementor Pro.
		require_once EMCP_TOOLS_DIR . 'includes/abilities/class-loop-grid-abilities.php';
		// Form Builder — structured form field creation for Elementor Pro Form widget.
		require_once EMCP_TOOLS_DIR . 'includes/abilities/class-form-builder-abilities.php';
		// Site Kit Manager — structured kit settings for site identity, layout, buttons.
		require_once EMCP_TOOLS_DIR . 'includes/abilities/class-site-kit-abilities.php';
		// Popup Builder — convenience wrapper for creating popups with triggers.
		require_once EMCP_TOOLS_DIR . 'includes/abilities/class-popup-abilities.php';
		// Layout presets — one-call preset layout patterns (hero, features, sidebar, faq).
		require_once EMCP_TOOLS_DIR . 'includes/abilities/class-layout-presets-abilities.php';
		...
		// Widget Builder: store, generator, loader, and MCP abilities.
