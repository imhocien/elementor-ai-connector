...
class EMCP_Tools_Custom_Code_Abilities {
	...
	public function register(): void {
		...
		// Custom CSS writes the custom_css setting key (same as the Advanced
		// tab panel). It does not call any Pro API, so it registers whenever
		// Elementor itself is active.
		$this->register_add_custom_css();

		// Code snippets use Elementor Pro's elementor_snippet CPT (Pro-only).
